 ...
 */
@interface _HBKVOInfo : NSObject
@end

@implementation _HBKVOInfo
{
@public
  __weak HBKVOController *_controller;
  NSString *_keyPath;
  NSKeyValueObservingOptions _options;
  SEL _action;
  void *_context;
  HBKVONotificationBlock _block;
}

- (instancetype)initWithController:(HBKVOController *)controller keyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options block:(HBKVONotificationBlock)block action:(SEL)action context:(void *)context
{
  self = [super init];
  if (nil != self) {
...
- (instancetype)initWithController:(HBKVOController *)controller keyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options block:(HBKVONotificationBlock)block
{
  return [self initWithController:controller keyPath:keyPath options:options block:block action:NULL context:NULL];
}

- (instancetype)initWithController:(HBKVOController *)controller keyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options action:(SEL)action
{
  return [self initWithController:controller keyPath:keyPath options:options block:NULL action:action context:NULL];
}

- (instancetype)initWithController:(HBKVOController *)controller keyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options context:(void *)context
{
  return [self initWithController:controller keyPath:keyPath options:options block:NULL action:NULL context:context];
}

- (instancetype)initWithController:(HBKVOController *)controller keyPath:(NSString *)keyPath
{
...
- (BOOL)isEqual:(id)object
{
  ...
  return [_keyPath isEqualToString:((_HBKVOInfo *)object)->_keyPath];
}
...
@implementation _HBKVOSharedController
{
  NSHashTable *_infos;
  OSSpinLock _lock;
}
...
+ (instancetype)sharedController
{
  static _HBKVOSharedController *_controller = nil;
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    _controller = [[_HBKVOSharedController alloc] init];
  });
  return _controller;
}
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context
{
  ...
  if (nil != info) {
    ...
    HBKVOController *controller = info->_controller;
    if (nil != controller) {
...
#pragma mark HBKVOController -

@implementation HBKVOController
{
...
- (NSString *)debugDescription
{
  ...
  for (id object in _objectInfosMap) {
    ...
    [infos enumerateObjectsUsingBlock:^(_HBKVOInfo *info, BOOL *stop) {
      [infoDescriptions addObject:info.debugDescription];
    }];
...
- (void)_observe:(id)object info:(_HBKVOInfo *)info
{
  // lock
  OSSpinLockLock(&_lock);
  ...
  _HBKVOInfo *existingInfo = [infos member:info];
  if (nil != existingInfo) {
  ...
  [[_HBKVOSharedController sharedController] observe:object info:info];
}

- (void)_unobserve:(id)object info:(_HBKVOInfo *)info
{
  // lock
  OSSpinLockLock(&_lock);
  ...
  _HBKVOInfo *registeredInfo = [infos member:info];
  ...
  // unobserve
  [[_HBKVOSharedController sharedController] unobserve:object info:registeredInfo];
}
...
- (void)_unobserve:(id)object
{
  ...
  // unobserve
  [[_HBKVOSharedController sharedController] unobserve:object infos:infos];
}
...
- (void)_unobserveAll
{
  ...
  _HBKVOSharedController *shareController = [_HBKVOSharedController sharedController];
...
- (void)observe:(id)object keyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options block:(HBKVONotificationBlock)block
{
  ...
  // create info
  _HBKVOInfo *info = [[_HBKVOInfo alloc] initWithController:self keyPath:keyPath options:options block:block];
...
- (void)observe:(id)object keyPaths:(NSArray *)keyPaths options:(NSKeyValueObservingOptions)options block:(HBKVONotificationBlock)block
{
...
- (void)observe:(id)object keyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options action:(SEL)action
{
  ...
  // create info
  _HBKVOInfo *info = [[_HBKVOInfo alloc] initWithController:self keyPath:keyPath options:options action:action];
...
- (void)observe:(id)object keyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options context:(void *)context
{
  ...
  // create info
  _HBKVOInfo *info = [[_HBKVOInfo alloc] initWithController:self keyPath:keyPath options:options context:context];
...
- (void)unobserve:(id)object keyPath:(NSString *)keyPath
{
  ...
  _HBKVOInfo *info = [[_HBKVOInfo alloc] initWithController:self keyPath:keyPath];
